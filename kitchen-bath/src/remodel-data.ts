...
export const billOfMaterials: BOMItem[] = [
  ...
  {
    id: "bom4",
    item: { en: "Silicone Caulk (sealing)", zh: "硅胶密封胶（密封用）", vi: "Keo silicon (trám kín)", es: "Sellador de silicona" },
    product: "GE Supreme Silicone Kitchen & Bath (White)",
    productUrl: "https://www.homedepot.com/p/GE-Supreme-Silicone-Caulk-10-1-oz-Kitchen-and-Bath-Sealant-White-2821640/317748964",
    quantity: "2-3 tubes",
    unitCostLow: 8,
    unitCostHigh: 10,
    room: "shared",
    status: "decided",
    notes: { en: "For sink, shower base, toilet base, and fixture sealing.", zh: "用于水槽、淋浴底座、马桶底座和固定装置密封。", vi: "Cho bồn rửa, đáy vòi sen, đáy bồn cầu và trám thiết bị.", es: "Para fregadero, base de ducha, base de inodoro y sellado de accesorios." },
  },
  {
    id: "bom4b",
    item: { en: "Sanded Caulk (grout transitions)", zh: "砂质填缝胶（灰缝过渡）", vi: "Keo trám có cát (chuyển tiếp mạch)", es: "Sellador con arena (transiciones de lechada)" },
    ...
    room: "shared",
    status: "decided",
    notes: { en: "Color-matched to grout. For tile-to-tub, tile-to-countertop, and change-of-plane joints.", zh: "与填缝剂颜色匹配。用于瓷砖与浴缸、瓷砖与台面及转角接缝处。", vi: "Màu phù hợp với mạch. Cho mối nối gạch-bồn tắm, gạch-mặt bàn và chỗ chuyển mặt phẳng.", es: "Color combinado con la lechada. Para juntas de azulejo a bañera, azulejo a encimera y cambios de plano." },
  },
  {
    id: "bom5",
